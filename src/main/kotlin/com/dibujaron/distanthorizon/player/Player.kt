...
import com.dibujaron.distanthorizon.script.impl.flatfile.PostgresScriptDatabase
...
class Player(val connection: WsContext) {
    ...
    private val myShipController: PlayerShipController = PlayerShipController(PostgresScriptDatabase(), false)
    val ship: Ship = Ship(
