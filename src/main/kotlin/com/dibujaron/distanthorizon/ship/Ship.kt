...
class Ship(
    ...
    fun createFullShipJSON(): JSONObject {
        ...
        retval.put("main_engine_thrust", controller.getMainThrust())
        retval.put("manu_engine_thrust", controller.getManuThrust())
        retval.put("rotation_power", controller.getRotationPower())
